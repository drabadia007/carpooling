          ...
          {Cookies.get("tokken") ? (
            <div className={"main-buttons"}>
              ...
              <Link to="/active-trip">
                <Button
                  variant="warning"
                  className={activeTrip ? "main-button" : "hidden"}
                  disabled={"/active-trip" === location.pathname}
                  data-test="activeTrip-button"
                >
                  <AiIcons.AiOutlineCar
                    style={{
                      color: "black",
                      marginBottom: "0.1rem",
                      marginRight: "0.3rem",
                    }}
                    data-test="activeTrip-icon"
                  />{" "}
                  Active Trip
                </Button>
              </Link>
              <Link to="/drive">
                <Button
                  variant="warning"
                  className={activeTrip ? "hidden" : "main-button"}
                  disabled={"/drive" === location.pathname}
              ...
              <Link to="/ride">
                <Button
                  variant="warning"
                  className={activeTrip ? "hidden" : "main-button"}
                  disabled={"/ride" === location.pathname}
                  data-test="ride-button"
                >
